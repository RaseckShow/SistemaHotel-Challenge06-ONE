...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[]{"Alemania","Argentina", "Australia","Bolivia","Brasil","Canada", "Chile", "China","Colombia","Corea","Costa Rica","Cuba","Ecuador","Egipto","Escocia","España","Estados Unidos","Francia","Guatemala", "Holanda", "Honduras", "Inglaterra", "Italia", "Japon", "Marruecos", "Mexico", "Paraguay", "Peru", "Portugal", "Rusia", "Suiza"}));
		...
		JLabel lblNacionalidad = new JLabel("PAIS DE NACIMIENTO");
		...
		// txtNreserva.setText("5");
		String IDString = Integer.toString(huespedController.obtenerID());
		// IDString.forEach(reservaID -> );
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (txtNombre != null && txtApellido != null && txtFechaN.getDate() != null && txtTelefono != null) {
					guardar();
					Exito registroExitoso = new Exito();
    ...
    private int guardar() {
		...
		String selectdate = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		String pais = (String) txtNacionalidad.getSelectedItem();
		Integer reservacionID = Integer.parseInt(txtNreserva.getText()); 
		System.out.println("ID Reservacion: " + reservacionID);
		...
		dispose();
		System.out.println("Despues de guardar" + reservacionID);
